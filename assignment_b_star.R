...
preference_updater = function(preferences, assigned_patients, patient_names,
  ...
  if (hpbm) {
    ...
    # print(hpbm_patient)
    # print(as.character(hpbm_patient))
    # print(as.numeric(preferences[hpbm_patient,which(!preferences[hpbm_patient,]%in%assigned_patients)][1]))
    
    current_assignment[[as.character(hpbm_patient)]] <- as.numeric(preferences[hpbm_patient,which(!preferences[hpbm_patient,]%in%assigned_patients)][1])
  }else{
...
preference_updater2 = function(preferences, assigned_patients, patient_names,
                              hpbm = FALSE) {
...
# data = import_data(file_location = "data/test_mike3.xlsx") # TODO: remove when done
